...
Divorce proceedings start when one party files a *Petition for Dissolution of Marriage* and they end when the Court enters two or three Orders:
- *Judgment of Dissolution of Marriage ("JDM")* - Mostly standardized Order that legally ends the marriage and incorporates the MSA and AJ by reference. 
- *Marital Settlement Agreement ("MSA")* - An agreement between parties which defines all property rights, spousal support, and/or child support between the parties after the divorce. This agreement becomes an enforcable Order of the court by reference to the JDM. If the parties cannot come to an agreement regarding property or other terms, then the Judge will decide based on the facts and the law which seeks fairness that is within the guidelines of the statutes. 
- *Allocation Judgment ("AJ")* - All divorces where the parties share a child will also have a Judgment of Allocation of Parental Responsibilities, or 'Allocation Judgment.'  This is a required Order defining parental rights and responsibilities of each parent.  The AJ will include details of the child's schedule and of how the parties will make decisions about the child's healthcare, education, and general well-being.  If the parents cannot agree, then the Judge will decide the terms of the Allocation Judgment based on the child's best interest. 

The Court's proceedings are designed to help the parties come to agreement on the JDM, MSA, and AJ.  And that's it, you're divorced! So if that's "all" there is, why do divorces take so long?  Read more to find out.
...
<figure>
  <a href="/blogs/what-to-expect-when-getting-divorced-in-illinois/how-to-get-divorced-in-illinois.png" target="_blank" rel="noopener noreferrer">
    <img 
      src="/blogs/what-to-expect-when-getting-divorced-in-illinois/how-to-get-divorced-in-illinois.png" 
