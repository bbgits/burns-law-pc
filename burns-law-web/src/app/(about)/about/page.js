  ...
  return (
    <>
      ...
      <h2 className="mt-8 font-semibold text-lg md:text-2xl self-start mx-5 xs:mx-10 sm:mx-12 md:mx-16 lg:mx-20 text-dark dark:text-light dark:font-normal">
        <span className="font-extrabold underline">1 Hr Consult ($225)</span>{" "}
        Video Call to discuss your matter and help you understand your legal
        options. Payment due at start of meeting, Book Here.{" "}
      </h2>

      {/* Ensure the button with window.open only renders on the client */}
      {isClient && (
        <button
          onClick={() => {
            window.open(
              "https://calendly.com/brian-burnslawpc/legal-consult",
              "_blank"
            );
          }}
