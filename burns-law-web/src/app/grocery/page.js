    ...
    <main className="w-full px-4 md:px-10 lg:px-24 py-10 md:py-14 text-dark dark:text-light">
      <section className="max-w-4xl mx-auto">
        ...
        <p className="mt-5 text-base md:text-xl leading-relaxed text-dark/90 dark:text-light/90">
          Have you seen a low advertised shelf price, but then been required to
          use a digital coupon in a store with internet dead spots? We are
          reviewing claims involving unfair pricing practices and accessibility
          barriers that may cause consumers to pay more than advertised.
        </p>
