...
<svg
    ...
    width={42.373}
    height={42.403}
    viewBox="0 0 11.211 11.219"
    className={cx("w-full h-auto", className)}
    
    {...rest}
  >
    <path
      d="M47.762 220.031a2.356 2.356 0 0 1-1.789-1.594c-.082-.243-.087-.473-.087-3.987 0-3.514.005-3.744.087-3.987.243-.717.75-1.24 1.464-1.513l.278-.105h7.552l.278.105a2.402 2.402 0 0 1 1.464 1.513c.083.243.088.473.088 3.987 0 3.514-.005 3.744-.088 3.987a2.4 2.4 0 0 1-1.464 1.513l-.278.105-3.659.008c-2.012.004-3.743-.01-3.846-.032zm1.853-4.877v-2.58h-1.407v5.16h1.407zm2.345 1.181c0-1.527.029-1.744.265-2.025.364-.433 1.07-.432 1.379.002.21.296.233.485.233 1.998v1.424h1.407v-1.73c0-.965-.02-1.839-.047-1.978-.113-.593-.432-1.03-.93-1.276-.287-.141-.345-.153-.758-.15-.593.004-.9.12-1.276.487l-.273.265v-.778h-1.407v5.16h1.407zm-2.735-4.42c.626-.238.657-1.2.047-1.495a.745.745 0 0 0-.722 0c-.593.288-.588 1.212.01 1.478.17.076.486.084.665.016z"
      style={{
        
        fillRule: "evenodd",
        strokeWidth: 0.177293,
      }}
      transform="translate(-45.886 -208.845)"
    />
  </svg>
  );
};
